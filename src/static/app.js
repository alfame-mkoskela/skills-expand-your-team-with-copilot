  ...
  function displayFilteredActivities() {
    ...
    Object.entries(allActivities).forEach(([name, details]) => {
      ...
      if (currentDifficulty) {
        // If a specific difficulty is selected, show only activities with that exact
        // difficulty level. Activities with no difficulty set (details.difficulty is
        // undefined/null) are considered suitable for all levels and always pass through.
